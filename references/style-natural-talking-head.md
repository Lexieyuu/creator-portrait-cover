# Default Style — Natural Talking-Head Cover

Use this visual language by default when the user does not request a different aesthetic. It is distilled from natural self-media talking-head covers: the person feels like a real creator speaking in an ordinary, well-composed room.
...
- **Texture:** natural skin texture, slight asymmetry, believable hair detail, realistic fabric, and mild photographic softness. Avoid plastic retouching and hyper-clean synthetic surfaces.
- **Layout:** reserve clean negative space around the upper or side area for copy added later, but keep the generated image itself completely text-free.
