...
- The environment image is the spatial and compositional baseline: do not redesign it or casually recrop it. Remove desk/workspace elements, foreground horizontal surfaces, and incidental text so the final environment is clean and subordinate.
...
- Edit the background around the protected person only. Do not regenerate the full image or use the person as a prompt for a new subject.
