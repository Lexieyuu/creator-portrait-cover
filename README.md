...
一个用于生成真实拍摄感、自然生活感、近距离口播感自媒体人物封面的 Codex Skill。默认输出 3:4 竖版构图，人物通常占画面高度约 75%。
...
- 默认不生成桌面、书桌、电脑、笔记本、键盘、咖啡杯等办公桌面效果
- 上传的人物优先作为完整图层挪入环境，不重新生成或改造人物
- 优先使用人物保护蒙版，只编辑环境区域；无法使用蒙版时，宁可降低背景复杂度，也不要重绘人物
...
`自然口播感、生活化室内空间、人物主体约占75%、半身中近景、浅景深、背景柔焦、自然窗光、柔和漫反射、真实皮肤纹理、真实手势、轻微抓拍感、人物被环境自然托住、干净留白、无文字、无桌面`

```text
使用 $creator-portrait-cover，把人物图作为完整人物图层挪入环境图。保留上传人物原本的脸、表情、头发、服装、姿势、手和身体裁切，只调整位置、大小、透视和光影来适应环境；人物占画面约 75%，环境只用于承托人物，不要生成桌面或办公桌面效果，不要重新生成这个人。
```
